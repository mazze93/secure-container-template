...
- Dependabot auto-merge workflow restricted to low-risk indirect `pip` updates
...
- Split CI into `validate` and `publish` jobs with artifact promotion between them
- Pinned the Docker base image and Hadolint runtime image by digest
